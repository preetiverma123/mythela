    ...
    <body onload="activatePlacesSearch();">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 col-sm-12 text-center">
                    ...
                    <div class="my-form">
                        <div class="row frm1">
                            <div class="scrollmenu">
                                <a class="incity" href="book-now.php"><span class="in active-btn">INCITY</span></a>
                                <a class="outcity" href="book-outstation.php"><span class="out">OUTCITY</span></a>
                                <a class="transport" href="book-logistics.php"><span class="tra">TRANSPORT</span></a>
                                <a class="rentals" href="book-rentals.php"><span class="ren">RENTALS</span></a>
                            </div>
                        </div>
                        <div class="step1">
                            <div class="row">
                        ...
                        <!-- step 1 ends -->
                        <div class="steppickup" style="display:none;">
                            <div class="back2"><i class="fa fa-long-arrow-left"></i></div>
                        ...
                        <!-- step 2 ends -->
                        <!--step3 starts-->
                        <div class="stepdrop" style="display:none;">
                            <div class="back2"><i class="fa fa-long-arrow-left"></i></div>
                        ...
                        <div class="map" style="display:none;">
                            ...
                            <button class="btn btn-skin btn-block confirm-loc">Confirm Location</button>
                    ...
                    <div class="fleet-row card row">
                        <div class="col-xs-2 fl text-center">
                            <img class="fleet-img" src="img/fleet/bike.png"><br/>
                            <div class="fleet-time">5 mins</div>
                        </div>
                        <div class="col-xs-9 fl">
                    ...
                    <div class="fleet-row card row">
                        <div class="col-xs-2 fl text-center">
                            <img class="fleet-img" src="img/fleet/micro.png"><br/>
                            <div class="fleet-time">5 mins</div>
                        </div>
                        <div class="col-xs-9 fl">
                    ...
                    <div class="fleet-row card row">
                        <div class="col-xs-2 fl text-center">
                            <img class="fleet-img" src="img/fleet/mini.png"><br/>
                            <div class="fleet-time">5 mins</div>
                        </div>
                        <div class="col-xs-9 fl">
                    ...
                    <div class="fleet-row card row">
                        <div class="col-xs-2 fl text-center">
                            <img class="fleet-img" src="img/fleet/prime.png"><br/>
                            <div class="fleet-time">5 mins</div>
                        </div>
                        <div class="col-xs-9 fl">
                    ...
                    <div class="fleet-row card row">
                        <div class="col-xs-2 fl text-center">
                            <img class="fleet-img" src="img/fleet/prime-play.png"><br/>
                            <div class="fleet-time">5 mins</div>
                        </div>
                        <div class="col-xs-9 fl">
                    ...
                    <div class="fleet-row card row">
                        <div class="col-xs-2 fl text-center">
                            <img class="fleet-img" src="img/fleet/share.png"><br/>
                            <div class="fleet-time">5 mins</div>
                        </div>
                        <div class="col-xs-9 fl">
                    ...
                    <div class="fleet-row card row">
                        <div class="col-xs-2 fl text-center">
                            <img class="fleet-img" src="img/fleet/suv.jpg"><br/>
                            <div class="fleet-time">5 mins</div>
                        </div>
                        <div class="col-xs-9 fl">
                    ...
                    <div class="fleet-row card row">
                        <div class="col-xs-2 fl text-center">
                            <img class="fleet-img" src="img/fleet/lux.png"><br/>
                            <div class="fleet-time">5 mins</div>
                        </div>
                        <div class="col-xs-9 fl">
                    ...
                    <div class="fleet-row card row">
                        <div class="col-xs-2 fl text-center">
                            <img class="fleet-img" src="img/fleet/erick.jpg"><br/>
                            <div class="fleet-time">5 mins</div>
                        </div>
                        <div class="col-xs-9 fl">
        ...
        <script>
            function activatePlacesSearch(){
                var picuploc=document.getElementById('picuploc');
                 new google.maps.places.Autocomplete(picuploc);
                 var droploc=document.getElementById('droploc');
                 new google.maps.places.Autocomplete(droploc);
               //  $('#searchhtext').val(picuploc);
            }
        </script> 
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAgBb4OafYhJTN5L-irYGsGtuzCqsmFQA8&libraries=places"
