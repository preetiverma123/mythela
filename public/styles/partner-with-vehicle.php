...
<html lang="en">
    ...
    <body>
      <?php include'loader.php' ?>
        ...
        <div class="banner-bg5 jumbotron">
        ...
        <div class="container bg-3 text-center">
            <h2>Freedom of work, Daily payments</h2>
        ...
        <div class="container bg-3 text-center">
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <h4>Choose your own<br/> working hours</h4>
                    <br/></div>
                </div>
                <div class="col-sm-3">
                    <div class="thela-item">
                        <br/>
                    <i class="fa fa-4x fa-thumbs-o-up" aria-hidden="true"></i>
                  <h4>Daily payments <br/>365 days</h4>
                   <br/></div>
                </div>
                <div class="col-sm-3">
                    <div class="thela-item">
                ...
                <div class="col-sm-3">
                    <div class="thela-item">
                        <br/>
                    <i class="fa fa-4x fa-building-o" aria-hidden="true"></i>
                   <h4> Choose from 100+<br/> cities to work in</h4>
                    <br/></div>
                </div>
            </div>
        </div>
