...
<div class="banner-bg2 jumbotron">
                        ...
                        <div class="my-form">
                            <div class="col-xs-12 frm1">
                                <div class="scrollmenu">
                                  ...
                                  <a class="outcity" href="outstation.php"><span class="active-btn">OUTCITY</span></a>
                            ...
                            <div class="row">
                                ...
                                <p><br/></p>
                                <div class="frm2">
                                   <h4 class="frm1-head">The Intercity Express</h4>
								AC Cabs for inter-city travel
                                </div>
                            </div>
                            <div class="text-left">
                            ...
                            <a href="book-outstation.php" class="btn btn-skin btn-block">BOOK NOW</a>
							</div>
							<!-- step 1 ends -->
...
.height40{height:40px; background-color:rgba(255,255,255,0.7);width:100%;color:#000;border-radius: 6px;border-width: 1px;}
							...
							<div class="inner-addon left-addon">
								<i class="glyphicon glyphicon-search"></i>
								<input type="text" class="height40 form-control" placeholder="Enter drop location"/>
							</div>
