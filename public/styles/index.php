...
<html lang="en">
  ...
  <?php include'loader.php' ?>
        ...
        <div class="banner-bg3 jumbotron">
                        ...
                        <div class="my-form">
                            <div class="col-xs-12 frm1">
                                <div class="scrollmenu">
                                  <a class="incity" href="index.php"><span class="active-btn">INCITY</span></a>
                                  <a class="outcity" href="outstation.php"><span>OUTCITY</span></a>
                                  <a class="transport" href="transport.php"><span>TRANSPORT</span></a>
                                  <a class="rentals" href="rentals.php"><span>RENTALS</span></a>
                                </div>
                            </div>
							<div class="step1">
                            <div class="row">
                            ...
                            <a href="book-now.php" class="btn btn-skin btn-block">BOOK NOW</a>
							</div>
							<!-- step 1 ends -->
							...
							<div id="optlocation"></div>
							<div class="text-center powered"><img src="img/powered-by-google-on-white.png" width="100px"></div>
                         	<style>
	 .inner-addon {position: relative;margin:8px 0;}.powered{background-color:rgba(255,255,255,0.7);padding:10px;border-radius: 4px;}
/* style icon */.inner-addon .glyphicon {position: absolute;padding: 11px;font-size: 17px;pointer-events: none;color:#000;}
/* align icon */.left-addon .glyphicon  { left:  0px;}.right-addon .glyphicon { right: 0px;}
/* add padding*/.left-addon input  { padding-left:  35px; }.right-addon input { padding-right: 30px; }
      ...
      $(".step3").css("display", "none");
        ...
        <div class="container bg-3">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="htt"><strong>FASTEST GROWING COMPANY</strong></div>
                    <br/>
