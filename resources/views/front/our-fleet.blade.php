...
<br/><br/>
<style>
.fleet-nav>li>a {font-weight:500;padding: 8px 10px;
}
@media only screen and (max-width: 400px) {
    .fleet-nav>li>a {font-weight:normal;padding: 3px 5px;
}
}
@media only screen and (max-width: 350px) {
    .fleet-nav>li>a {font-weight:normal;padding: 3px 5px;font-size:11px;
}
}
