...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="dist/css/Adminthela.min.css">
...
<div class="wrapper">
           ...
           <div class="box box-info">
            ...
            <form class="form-horizontal">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="password" class="form-control" id="inputEmail3" placeholder="Enter old password">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="password" class="form-control" id="inputPassword3" placeholder="Re-Enter New Password">
                  </div>
                </div>
 ...
 <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 <a href="#">Aapsworld</a>.</strong> All rights
    reserved.
  </footer>
