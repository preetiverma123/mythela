                        ...
                        <div class="my-form">
                            <div class="col-xs-12 frm1">
                                <div class="scrollmenu">
                                  ...
                                  <a class="transport" href="transport.php"><span class="active-btn">TRANSPORT</span></a>
                            ...
                            <a href="book-logistics.php" class="btn btn-skin btn-block">Book Now</a>
							</div>
							<!-- step 1 ends -->
...
<div class="container bg-3 text-center">    
  <div class="row">
    ...
    <div class="col-sm-3">
	<div class="thela-item">
      <img src="img/4.jpg" class="img-responsive" style="width:100%" alt="Image">
