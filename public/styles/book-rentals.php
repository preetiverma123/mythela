                ...
                <div class="col-md-4 col-sm-12 text-center">
					...
					<div class="row frm1">
                                ...
                                <div class="scrollmenu">
                                  ...
                                  <a class="outcity" href="book-outstation.php"><span class="">OUTCITY</span></a>
                                  <a class="transport" href="book-logistics.php"><span class="">TRANSPORT</span></a>
                                  <a class="rentals" href="book-rentals.php"><span class="active-btn">RENTALS</span></a>
                                </div> 
